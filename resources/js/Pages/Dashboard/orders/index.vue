                        ...
                        <div
                            ...
                            <table class="min-w-full">
                                ...
                                <tr v-for="order in orders.data">
                                    ...
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <span class="px-2 py-1 bg-green-500 text-white text-xs rounded" v-if="order.editable">يمكن التعديل</span>
                                        <span class="px-2 py-1 bg-yellow-500 text-white text-xs rounded" v-else>لا يمكن التعديل</span>
                                    </td>
                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                        <span class="px-2 py-1 bg-green-500 text-white text-xs rounded" v-if="order.delivered">تم التوصيل</span>
                                        <span class="px-2 py-1 bg-yellow-500 text-white text-xs rounded" v-else>لم يتم التوصيل</span>
                                    </td>

                                    <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200 text-sm leading-5 font-medium">
                                        <inertia-link :href="'#'" class="text-indigo-600 hover:text-indigo-900">تعديل</inertia-link>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
