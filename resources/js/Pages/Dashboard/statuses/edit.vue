<template>
    <layout>
        ...
        <div class="mt-8">
            <div class="flex">
                <h2 class="text-3xl text-indigo-500 font-bold">الحالة /<span class="text-gray-700"> تعديل</span>
                </h2>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            submit() {
                this.$inertia.put(this.$route('statuses.update', this.status.id), this.form);
            }
        }
    }
</script>
